...
public class UserData {
	...
	/*public void createConnectedData(String userID, List <String> Connected) {
		Document setData = new Document();
		setData.append("connected", Connected);
		Document update = new Document();
		update.append("$set", setData);
	...
	public List<User> getConnectedData(String userID) {
		...
		colUser.find(eq("userID", userID)).projection(fields(include("connected"), excludeId()))
				.forEach(printBlock);
	...
	public void removeConnectedData(String userID, String [] Connected) {
		Document setData = new Document();
		setData.append("connected", Connected);
		Document update = new Document();
		update.append("$set", setData);
